...
class HistoryTravelsFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = HistoryTravelsFragment()
    }

    private lateinit var viewModel: HistoryTravelsViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(HistoryTravelsViewModel::class.java)
